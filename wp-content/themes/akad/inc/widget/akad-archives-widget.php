 ...
 * @see WP_Widget
 */
class Akad_Widget_Archives extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'akad_widget_archive',
			'description' => __( 'A monthly archive of your site&#8217;s Posts.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct('akad_archives', __('AKAD Archives'), $widget_ops);
	}
...
add_action( 'widgets_init', 'register_archive_widgets' );
function register_archive_widgets() {
	register_widget( 'Akad_Widget_Archives' );
}