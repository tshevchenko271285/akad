 ...
 * @see WP_Widget
 */
class Akad_Widget_Tag_Cloud extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'akad_tag_cloud', __( 'Akad Tag Cloud' ), $widget_ops );
	}
...
add_action( 'widgets_init', 'register_tags_cloud_widgets' );
function register_tags_cloud_widgets() {
	register_widget( 'Akad_Widget_Tag_Cloud' );
}