...
function akad_scripts() {
	...
	//wp_enqueue_script( 'akad-jquery-google-map-script', '//maps.googleapis.com/maps/api/js?sensor=falsemaps.googleapis.com/maps/api/js?sensor=false', array(), '20151215', true );
